...
do
	...
	local Themes = {
		["Preset"] = {
			["Window Outline"] = FromRGB(20, 184, 166),
	...
	do
		...
		Library.ESPPreview = function(self, Window, Data)
			local Preview = { }
			Preview.Items = { }
			Preview.Player = nil 
			...
			local Items = { } do 
				Items["ESPPreview"] = Instances:Create("Frame", {
					...
					BorderColor3 = FromRGB(255, 0, 0),  
					Size = UDim2New(0, 230, 0, 296),
					BorderSizePixel = 2,
					BackgroundColor3 = FromRGB(17, 21, 27)
				})  
				
				Items["ESPPreview"]:AddToTheme({ 
					BackgroundColor3 = "Background 1",
					BorderColor3 = "Window Outline"  
				})
				...
				Library.CharacterViewport = Items["CharacterViewport"]
				...
				-- box
                    ...
                    Items["BoxFill"] = Instances:Create("Frame", {
                    ...
                    Items["BoxInline"] = Instances:Create("Frame", {
                        Parent = Items["BoxHolder"].Instance,
                        Name = "\0",
                        BackgroundTransparency = 1,
                        Position = UDim2New(0, -1, 0, -1),
                    ...
                    Items["BoxColor"] = Instances:Create("UIStroke", {
                        Parent = Items["BoxInline"].Instance,
                        Name = "\0",
				...
				Items["Weapon"] = Instances:Create("TextLabel", {
					Parent = Items["Holder"].Instance,
					Name = "\0",
					FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal), 
					TextColor3 = FromRGB(255, 255, 255),
				...
				Items["HealthbarAccent"] = Instances:Create("Frame", {
					Parent = Items["Healthbar"].Instance,
					Name = "\0",
					AnchorPoint = Vector2New(0, 1),
				...
				Items["SkeletonLines"] = Instances:Create("Frame", {
					Parent = Items["Holder"].Instance,
					Name = "\0",
					BackgroundTransparency = 1,
					BorderColor3 = FromRGB(0, 0, 0),
				...
				Items["LHLLA"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.10077519714832306, 0, 0.4861878454685211, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 20),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				})
				
				Instances:Create("UIStroke", {
					Parent = Items["LHLLA"].Instance,
					Name = "\0"
				})
				
				Items["LLALUA"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.10100000351667404, 0, 0.3540000021457672, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 24),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				})
				
				Instances:Create("UIStroke", {
					Parent = Items["LLALUA"].Instance,
					Name = "\0"
				})
				
				Items["LUAUT"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Rotation = 12,
					Position = UDim2New(0.10100000351667404, 0, 0.3540000021457672, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 50, 0, 1),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				})
				
				Instances:Create("UIStroke", {
					Parent = Items["LUAUT"].Instance,
					Name = "\0"
				})
				
				Items["UTHRP"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.44999998807907104, 2, 0.38199999928474426, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 40),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				})
				
				Instances:Create("UIStroke", {
					Parent = Items["UTHRP"].Instance,
					Name = "\0"
				})
				
				Items["HRPLUL"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Rotation = 18,
					Position = UDim2New(0.41100001335144043, 1, 0.5920000076293945, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 25),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				})
				
				Instances:Create("UIStroke", {
					Parent = Items["HRPLUL"].Instance,
					Name = "\0"
				})
				
				Items["LULLLL"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.41100001335144043, -2, 0.6859999895095825, 5),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 40),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				...
				Instances:Create("UIStroke", {
					Parent = Items["LULLLL"].Instance,
					Name = "\0"
				})
				
				Items["HRPRUL"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Rotation = -18,
					Position = UDim2New(0.5099999904632568, 1, 0.5920000076293945, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 25),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				...
				Instances:Create("UIStroke", {
					Parent = Items["HRPRUL"].Instance,
					Name = "\0"
				})
				
				Items["RULRLL"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.550000011920929, -2, 0.6859999895095825, 5),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 40),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				...
				Instances:Create("UIStroke", {
					Parent = Items["RULRLL"].Instance,
					Name = "\0"
				})
				
				Items["RUAUT"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Rotation = -12,
					Position = UDim2New(0.5, -2, 0.3540000021457672, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 50, 0, 1),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				...
				Instances:Create("UIStroke", {
					Parent = Items["RUAUT"].Instance,
					Name = "\0"
				})
				
				Items["RLARUA"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.8500000238418579, 0, 0.3540000021457672, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 24),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
				...
				Instances:Create("UIStroke", {
					Parent = Items["RLARUA"].Instance,
					Name = "\0"
				})
				
				Items["RHRLA"] = Instances:Create("Frame", {
					Parent = Items["SkeletonLines"].Instance,
					Name = "\0",
					Position = UDim2New(0.8500000238418579, 0, 0.4861878454685211, 0),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 1, 0, 20),
					BorderSizePixel = 0,
					BackgroundColor3 = FromRGB(255, 255, 255)
			...
			ViewportModel = loadstring(game:HttpGet("https://gc9.xyz/r6Rig.lua"))()

			ViewportModel.PrimaryPart.Anchored = true
			ViewportModel.Parent = Items["CharacterViewport"].Instance

			Library.ViewportModel = ViewportModel
			...
			ViewportModel.PrimaryPart = ViewportModel:FindFirstChild("HumanoidRootPart")
			ViewportModel:SetPrimaryPartCFrame(CFrame.Angles(0, math.rad(180), 0) + Vector3.new(0, 2, 0))
			ViewportCamera.CFrame = CFrame.new(Vector3.new(0, 2, 6), Vector3.new(0, 1, 0))
			Preview.Player = ViewportModel
			...
			local ClampPitch = function(PitchValue)
				return MathClamp(PitchValue, math.rad(-80), math.rad(80))
			end
			...
			Items["CharacterViewport"]:Connect("InputBegan", function(Input)
				if Input.UserInputType == Enum.UserInputType.MouseButton1 then
					...
					if ViewportInputChanged then return end
			...
			Items["CharacterViewport"]:Connect("InputChanged", function(Input)
				if Input.UserInputType == Enum.UserInputType.MouseMovement then
					if not LastPosition or not IsRotating then return end
					local delta = Input.Position - LastPosition
					LastPosition = Input.Position
					Yaw -= math.rad(delta.X * Sensitivity)
					Pitch = ClampPitch(Pitch - math.rad(delta.Y * Sensitivity))
				elseif Input.UserInputType == Enum.UserInputType.MouseWheel then
					Distance = math.clamp(Distance - Input.Position.Z * 0.5, 3, 12)
				end
			end)
			...
			Library:Connect(RunService.RenderStepped, function(dt)
				if not Library.ViewportModel or not Library.ViewportModel.PrimaryPart then return end

				local camOffset = CFrame.new(0, 0, Distance)
				local rotation = CFrame.Angles(Pitch, Yaw, Roll)
				local final = rotation * camOffset
				local camPos = Target + final.Position
				ViewportCamera.CFrame = CFrame.new(camPos, Target)
				Library.ViewportModel:SetPrimaryPartCFrame(CFrame.new(Target))

				if Window.Debounce then return end
				local visualsActive = false
				for _, page in Window.Pages do
					if page.Name == "Visuals" and page.Active then
						visualsActive = true
						break
					end
				end

				local target = visualsActive and 0 or 1
				Alpha += (target - Alpha) * math.clamp(dt * 30, 0, 1)
				Items["ESPPreview"].Instance.BackgroundTransparency = Alpha

				if Library.ViewportModel then
					for _, v in ipairs(Library.ViewportModel:GetDescendants()) do
						if v:IsA("BasePart") then
							v.LocalTransparencyModifier = Alpha
						elseif v:IsA("Decal") or v:IsA("Texture") then
							v.Transparency = Alpha
						elseif v:IsA("Highlight") then
							v.FillTransparency = Alpha
							v.OutlineTransparency = Alpha
						end
					end
				end

				if visualsActive and not Items["ESPPreview"].Instance.Visible then
					Items["ESPPreview"].Instance.Visible = true
				elseif not visualsActive and Alpha > 0.98 then
					Items["ESPPreview"].Instance.Visible = false
				end
			end)

			local linePos = function(frame, from, to, thickness, playerPos)
				...
				local distance = (playerPos - Camera.CFrame.Position).Magnitude
		
				frame.Position = UDim2.new(0, center.X, 0, center.Y)
				frame.Rotation = math.deg(math.atan2(offset.Y, offset.X))
				frame.Size = UDim2.new(0, offset.Magnitude, 0, thickness)
			end

			local parts = {
				UpperTorso_LowerTorso = Items["UTHRP"].Instance,

				UpperTorso_LeftUpperArm = Items["LUAUT"].Instance,
				LeftUpperArm_LeftLowerArm = Items["LLALUA"].Instance,
				LeftLowerArm_LeftHand = Items["LHLLA"].Instance,

				UpperTorso_RightUpperArm = Items["RUAUT"].Instance,
				RightUpperArm_RightLowerArm = Items["RLARUA"].Instance,
				RightLowerArm_RightHand = Items["RHRLA"].Instance,

				LowerTorso_LeftUpperLeg = Items["HRPLUL"].Instance,
				LeftUpperLeg_LeftLowerLeg = Items["LULLLL"].Instance,
				LeftLowerLeg_LeftFoot = Items["LULLLL"].Instance,

				LowerTorso_RightUpperLeg = Items["HRPRUL"].Instance,
				RightUpperLeg_RightLowerLeg = Items["RULRLL"].Instance,
				RightLowerLeg_RightFoot = Items["RULRLL"].Instance
			}

			function Preview:Update(Type, MasterSwitch, Data)
				Items["Holder"].Instance.Visible = MasterSwitch

				if Type == "Box" then
					Items["BoxFill"].Instance.Visible = Data.Filled
					Items["BoxFill"].Instance.BackgroundTransparency = Data.FillTransparency
					Items["BoxFill"].Instance.BackgroundColor3 = Data.FillColor

					Items["BoxHolder"].Instance.Visible = Data.Enabled 
					Items["BoxColor"].Instance.Color = Data.Color
				elseif Type == "Name" then 
					Items["Name"].Instance.Visible = Data.Enabled
					Items["Name"].Instance.TextColor3 = Data.Color
					Items["Name"].Instance.Text = Data.Text
				elseif Type == "Distance" then 
					Items["Distance"].Instance.Visible = Data.Enabled
					Items["Distance"].Instance.TextColor3 = Data.Color
				elseif Type == "Weapon" then 
					Items["Weapon"].Instance.Visible = Data.Enabled
					Items["Weapon"].Instance.TextColor3 = Data.Color
				elseif Type == "Healthbar" then 
					Items["Healthbar"].Instance.Visible = Data.Enabled
					Items["HealthbarText"].Instance.Visible = Data.TextEnabled
				elseif Type == "Skeleton" then 
					Items["SkeletonLines"].Instance.Visible = Data.Enabled

					if Library.Flags["Enable Skeletons"] then
						local getParts = {
						...
						for _, v in pairs(getParts) do
							if not Preview.Player:FindFirstChild(v) then
						...
						if next(positions) then
							local thickness = Library.Flags["Skeleton Thickness"]
							local root = Preview.Player:FindFirstChild("HumanoidRootPart")
							local rootPos = root and root.Position or Preview.Player:GetPivot().Position
			
							linePos(parts.UpperTorso_LowerTorso, positions.UpperTorso, positions.LowerTorso, thickness, rootPos)
			
							linePos(parts.UpperTorso_LeftUpperArm, positions.UpperTorso, positions.LeftUpperArm, thickness, rootPos)
							linePos(parts.LeftUpperArm_LeftLowerArm, positions.LeftUpperArm, positions.LeftLowerArm, thickness, rootPos)
							linePos(parts.LeftLowerArm_LeftHand, positions.LeftLowerArm, positions.LeftHand, thickness, rootPos)
			
							linePos(parts.UpperTorso_RightUpperArm, positions.UpperTorso, positions.RightUpperArm, thickness, rootPos)
							linePos(parts.RightUpperArm_RightLowerArm, positions.RightUpperArm, positions.RightLowerArm, thickness, rootPos)
							linePos(parts.RightLowerArm_RightHand, positions.RightLowerArm, positions.RightHand, thickness, rootPos)
			
							linePos(parts.LowerTorso_LeftUpperLeg, positions.LowerTorso, positions.LeftUpperLeg, thickness, rootPos)
							linePos(parts.LeftUpperLeg_LeftLowerLeg, positions.LeftUpperLeg, positions.LeftLowerLeg, thickness, rootPos)
							linePos(parts.LeftLowerLeg_LeftFoot, positions.LeftLowerLeg, positions.LeftFoot, thickness, rootPos)
			
							linePos(parts.LowerTorso_RightUpperLeg, positions.LowerTorso, positions.RightUpperLeg, thickness, rootPos)
							linePos(parts.RightUpperLeg_RightLowerLeg, positions.RightUpperLeg, positions.RightLowerLeg, thickness, rootPos)
							linePos(parts.RightLowerLeg_RightFoot, positions.RightLowerLeg, positions.RightFoot, thickness, rootPos)
			...
			function Preview:Set(Type, MasterSwitch, Data)
				self:Update(Type, MasterSwitch, Data)
			end

			function Preview:UpdateSkeleton(Color, Outline)
				for _, Part in parts do 
					Part.BackgroundColor3 = Color
					Part:FindFirstChild("UIStroke").Enabled =Outline
				end
			end

			local Math = { } do -- esp preview math is done differently
                local inf = math.huge
                ...
                function Math:GetBoundingBox(model, camera, ViewportFrame)
                    ...
                    local topLeft = Min
                    local Size = Vector2New(Size2D.X, Size2D.Y) * 1.1

                    return UDim2FromScale(Size.X, Size.Y)
                end
            end 

			Library:Connect(RunService.RenderStepped, function()	
                local Size = Math:GetBoundingBox(Preview.Player, ViewportCamera, Items.CharacterViewport.Instance)
                Items.Holder.Instance.Size = Size
            end)
		...
		Library.Window = function(self, Data)
			...
			local Window = {
				Name = Data.Name or Data.name or "Serotonin",
				Logo = Data.Logo or Data.logo or "rbxassetid://89100890385449",
			...
			function Window:SetOpen(Bool)
				...
				for Index, Value in Descendants do
					...
					if type(TransparencyProperty) == "table" then
						for _, Property in TransparencyProperty do
							LastTween = Tween:FadeItem(Value, Property, Bool, Library.FadeSpeed)
						end
					else
						LastTween = Tween:FadeItem(Value, TransparencyProperty, Bool, Library.FadeSpeed)
					end
				end

				local ViewportModel = Library.ViewportModel
				local ViewportLastTween
				if ViewportModel then
					local tinfo = TweenInfo.new(Library.FadeSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
					local fadeOut = not Bool

					for _, obj in ipairs(ViewportModel:GetDescendants()) do
						if obj:IsA("BasePart") then
							if obj:IsA("MeshPart") or obj:IsA("Part") or obj:IsA("UnionOperation") then
								local tw = TweenService:Create(obj, tinfo, {
									LocalTransparencyModifier = fadeOut and 1 or 0
								})
								tw:Play()
								ViewportLastTween = tw
							elseif obj:IsA("SpecialMesh") or obj:IsA("FileMesh") then
								local parentPart = obj.Parent
								if parentPart and parentPart:IsA("BasePart") then
									local tw = TweenService:Create(parentPart, tinfo, {
										LocalTransparencyModifier = fadeOut and 1 or 0
									})
									tw:Play()
									ViewportLastTween = tw
						...
						elseif obj:IsA("Decal") or obj:IsA("Texture") then
							local target = fadeOut and 1 or 0
							local tw = TweenService:Create(obj, tinfo, { Transparency = target })
							tw:Play()
							ViewportLastTween = tw
						elseif obj:IsA("Highlight") then
							local tw = TweenService:Create(obj, tinfo, {
								FillTransparency = fadeOut and 1 or 0,
								OutlineTransparency = fadeOut and 1 or 0
							})
							tw:Play()
							ViewportLastTween = tw
						end
				...
				local tweenToUse = ViewportLastTween or (LastTween and LastTween.Tween)
				if tweenToUse then
					tweenToUse.Completed:Connect(function()
...
local Window = Library:Window({
    Logo = "rbxassetid://89100890385449",
    FadeTime = 0.3,
})
...
PlayerESP.Functions.CreateDrawing = function(class, prop, ...)
...
PlayerESP.Functions.GetBoundings = function(model)
...
PlayerESP.Functions.IsVisible = function(character)
    if not character or character == lp.Character then
        return false
    end
    ...
    local raycastResult = Workspace:Raycast(Camera.CFrame.p, (part.Position - Camera.CFrame.p).Unit * 10000, raycastParams)
...
PlayerESP.Functions.GetTool = function(character)
    for _, value in pairs(character:GetChildren()) do
        if value.Name ~= "HolsterModel" and value:IsA("Model") and value.Name ~= "Hair" and 
           (value:FindFirstChild("Detail") or value:FindFirstChild("Main") or value:FindFirstChild("Handle") or 
            value:FindFirstChild("Attachments") or value:FindFirstChild("ArrowAttach") or value:FindFirstChild("Attach")) and 
           value.PrimaryPart then
            return value.Name
        end
    end
    return "None"
...
PlayerESP.UpdatePlayerESP = function(player)
    if (player.Name == LocalPlayerName) then
        return
    end

    local espHolder = PlayerESP.Functions.CreateDrawing("ScreenGui", { Parent = game:GetService("CoreGui"), Name = "esp_holder" })
    local drawings = {
        name = PlayerESP.Functions.CreateDrawing("TextLabel", {
            Visible = false,
            Parent = espHolder,
            BackgroundTransparency = 1,
        ...
        distance = PlayerESP.Functions.CreateDrawing("TextLabel", {
            Visible = false,
            Parent = espHolder,
            BackgroundTransparency = 1,
            TextStrokeTransparency = 0,
        ...
        weapon = PlayerESP.Functions.CreateDrawing("TextLabel", {
            Visible = false,
            Parent = espHolder,
            BackgroundTransparency = 1,
            TextStrokeTransparency = 0,
        ...
        box = PlayerESP.Functions.CreateDrawing("Frame", {
            Visible = false,
            Parent = espHolder,
            BackgroundTransparency = 1,
        ...
        box2 = PlayerESP.Functions.CreateDrawing("Frame", {
            Visible = false,
            Parent = espHolder,
            BackgroundTransparency = 1,
            BackgroundColor3 = Color3.new(1, 1, 1),
        ...
        Outline = PlayerESP.Functions.CreateDrawing("UIStroke", {
        ...
        Outline2 = PlayerESP.Functions.CreateDrawing("UIStroke", {
            Thickness = 1,
            Enabled = true,
            LineJoinMode = Enum.LineJoinMode.Miter
        }),

        BehindHealthbar = PlayerESP.Functions.CreateDrawing("Frame", {
            Visible = false,
            Parent = espHolder,
            ZIndex = -1,
        ...
        Healthbar = PlayerESP.Functions.CreateDrawing("Frame", {
            Visible = false,
            Parent = espHolder,
        ...
        HealthText = PlayerESP.Functions.CreateDrawing("TextLabel", { 
            Visible = false,
            Parent = espHolder, 
        ...
        name_stroke = PlayerESP.Functions.CreateDrawing("UIStroke", {
            Thickness = 1,
            LineJoinMode = Enum.LineJoinMode.Round,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual,
            Color = Color3.fromRGB(0, 0, 0)
        }),
        distance_stroke = PlayerESP.Functions.CreateDrawing("UIStroke", {
            Thickness = 1,
            LineJoinMode = Enum.LineJoinMode.Round,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual,
            Color = Color3.fromRGB(0, 0, 0)
        }),
        weapon_stroke = PlayerESP.Functions.CreateDrawing("UIStroke", {
            Thickness = 1,
            LineJoinMode = Enum.LineJoinMode.Round,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual,
            Color = Color3.fromRGB(0, 0, 0)
    ...
    local function CreateLine()
        local frame = Instance.new("Frame", espHolder)
    ...
    table.insert(PlayerESP.DrawingCache, {
        name = drawings.name,
    ...
    local function UpdateESP()
        if not Library or not Library.Flags or not Library.Flags["ESP Enabled"] then 
            ...
            for _, part in pairs(viewangleParts) do
                part.Visible = false
            end
            chams.Enabled = false
            return
        ...
        local cframe, size, position = PlayerESP.Functions.GetBoundings(character)
        ...
        local maxDistance = (position - Camera.CFrame.Position).Magnitude
        if maxDistance >= (Library.Flags["Max ESP Distance"] or 1000) then
            for _, v in ipairs({"name", "box", "box2", "distance", "weapon", "BehindHealthbar", "HealthText", "Healthbar"}) do
                drawings[v].Visible = false
            end
            for _, part in pairs(parts) do
        ...
        if Library.Flags["Enable TeamCheck"] and (player == lp or (lp.Team and player.Team and lp.Team == player.Team)) then
            for _, v in ipairs({"name", "box", "box2", "distance", "weapon", "BehindHealthbar", "HealthText", "Healthbar"}) do
                drawings[v].Visible = false
            end
            for _, part in pairs(parts) do
        ...
        local scale = Vector2.new((ViewportSize.Y / height) * size.X, (ViewportSize.Y / height) * size.Y)
        
        if Library.Flags["Enable Names"] then
            drawings.name.Visible = true
            drawings.name.Text = Library.Flags["Display Name"] and player.DisplayName or player.Name
            drawings.name.TextColor3 = drawings.name.TextColor3:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Names Accent"].Color, 0.02)
            drawings.name.Position = UDim2.new(0, pos.X, 0, pos.Y - scale.Y / 2 - 6)
        else
            drawings.name.Visible = false
        end
        
        if Library.Flags["Enable Chams"] then
            chams.Enabled = true
            chams.DepthMode = Library.Flags["Chams Visible Check"] == "Always Visible" and Enum.HighlightDepthMode.AlwaysOnTop or Enum.HighlightDepthMode.Occluded
            chams.FillTransparency = Library.Flags["Chams Opacity"] / 100
            chams.OutlineTransparency = Library.Flags["Chams Opacity"] / 100
            chams.FillColor = chams.FillColor:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Chams Accent"].Color, 0.02)
            chams.OutlineColor = chams.OutlineColor:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Chams Accent"].Color, 0.02)
        else
            chams.Enabled = false
        end
        
        if Library.Flags["Enable Viewangle"] and character:FindFirstChild("Head") then
            local headPos = Camera:WorldToScreenPoint(character.Head.Position)
            local lookDir = character.Head.CFrame.LookVector
            local lineLength = Library.Flags["Viewangle Length"]
            local endPos = character.Head.Position + (lookDir * lineLength)
            local endPoint = Camera:WorldToScreenPoint(endPos)
        
            local positions = {
                Head = Vector2.new(headPos.X, headPos.Y),
                Look = Vector2.new(endPoint.X, endPoint.Y),
            }
        
            for _, part in pairs(viewangleParts) do
                part.BackgroundColor3 = part.BackgroundColor3:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Viewangle Accent"].Color, 0.02)
            end

            if Library.Flags["Outline Skeletons/ViewAngle"] then
                for _, part in pairs(viewangleParts) do
            ...
            if viewangleParts.Head then
                linePos(viewangleParts.Head, positions.Head, positions.Look, 1, character.Head.Position)
                for _, part in pairs(viewangleParts) do
                    part.Visible = true
                end
            end
        ...
        if Library.Flags["Enable Skeletons"] then
            ...
            for _, v in pairs(getParts) do
                ...
                local worldPos = character[v].Position
            ...
            if next(positions) then
                for _, part in pairs(parts) do
                    part.BackgroundColor3 = part.BackgroundColor3:Lerp(Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color or Library.Flags["Skeletons Accent"].Color, 0.02)
                end

                local borderSize = Library.Flags["Outline Skeletons/ViewAngle"] and 1 or 0
                for _, part in pairs(parts) do
                    part.BorderSizePixel = borderSize
                end
            
                local thickness = Library.Flags["Skeleton Thickness"]
                local root = character:FindFirstChild("HumanoidRootPart")
                local rootPos = root and root.Position or character:GetPivot().Position
        ...
        if Library.Flags["Enable Boxes"] then
            ...
            if Library.Flags["Boxes Filled"] then
                drawings.box.BackgroundTransparency = Library.Flags["Boxes Filled Opacity"] / 100
                drawings.box.BackgroundColor3 = Library.Flags["Filled Boxes Accent"].Color
            else
            ...
            drawings.Outline2.Color = drawings.Outline2.Color:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Boxes Accent"].Color, 0.02)
        else
            drawings.box.Visible = false
            drawings.box2.Visible = false
        end
        
        if Library.Flags["Enable Distance"] then
            local boxSide = pos.X + (scale.X / 2)
            local boxTop = pos.Y - (scale.Y / 2)
            drawings.distance.Position = UDim2.new(0, boxSide + 3, 0, boxTop - 1)
            drawings.distance.Visible = true
            drawings.distance.TextColor3 = drawings.distance.TextColor3:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Distance Accent"].Color, 0.02)
            drawings.distance.Text = string.format("%ds", math.floor(maxDistance))
        else
            drawings.distance.Visible = false
        end
        
        if Library.Flags["Enable Weapon"] then
            drawings.weapon.Visible = true
            drawings.weapon.Position = UDim2.new(0, pos.X - 2, 0, pos.Y + scale.Y / 2 + 11)
            drawings.weapon.TextColor3 = drawings.weapon.TextColor3:Lerp((Library.Flags["Highlight ESP"] and HighlightPlayer == player and Library.Flags["Highlight Accent"].Color) and Library.Flags["Highlight Accent"].Color or Library.Flags["Weapon Accent"].Color, 0.02)
            drawings.weapon.Text = PlayerESP.Functions.GetTool(character)
        else
            drawings.weapon.Visible = false
        end
        
        if Library.Flags["Enable Healthbar"] and humanoid.Health then
            local health, maxHealth = math.floor(humanoid.Health), humanoid.MaxHealth
            local healthColor = Color3.new(1, 0, 0):lerp(Color3.new(0.7, 0.8, 0), math.clamp(health / maxHealth, 0, 1))
            healthColor = healthColor:lerp(Color3.new(0, 1, 0), math.clamp((health / maxHealth - 0.5) * 2, 0, 1))
            ...
            if Library.Flags["Enable Healthtext"] then
                drawings.HealthText.TextColor3 = healthColor
            ...
            local barWidth = 1
            local barHeightAdjust = 3
            local targetHeight = scale.Y * (tween.current_health / maxHealth) + barHeightAdjust

            local barOffset = 5 + math.max(0, barWidth)
            drawings.Healthbar.Position = UDim2.new(0, pos.X - scale.X / 2 - barOffset, 0, pos.Y - scale.Y / 2 + scale.Y * (1 - tween.current_health / maxHealth) + 1)
            drawings.BehindHealthbar.Position = UDim2.new(0, pos.X - scale.X / 2 - barOffset, 0, pos.Y - scale.Y / 2 + 1)
            drawings.Healthbar.Size = UDim2.new(0, barWidth, 0, targetHeight)
            drawings.BehindHealthbar.Size = UDim2.new(0, barWidth, 0, scale.Y + barHeightAdjust)
            local targetTextPos = UDim2.new(0, pos.X - scale.X / 2 - 9, 0, pos.Y - scale.Y / 2 + scale.Y * (1 - tween.current_health / maxHealth) + 5) or UDim2.new(0, pos.X - scale.X / 2 + scale.X * (tween.current_health / maxHealth), 0, pos.Y + scale.Y / 2 + 5)
            drawings.HealthText.Position = drawings.HealthText.Position:Lerp(targetTextPos, progress)
            drawings.Healthbar.BackgroundColor3 = healthColor
        else
    ...
    local cache = PlayerESP.DrawingCache[#PlayerESP.DrawingCache]
    cache.update_conn = RunService.RenderStepped:Connect(UpdateESP)
end

PlayerESP.RemovePlayerESP = function(player)
    for i, cache in ipairs(PlayerESP.DrawingCache) do
        if cache.player == player then
            if cache.update_conn then
                cache.update_conn:Disconnect()
            end
            cache.esp_holder:Destroy()
            table.remove(PlayerESP.DrawingCache, i)
            break
        end
    end
end

PlayerESP.OnPlayerAdded = function(player)
    if type(player) ~= 'table' then
        local connections = {}
        connections.characterAdded = player.CharacterAdded:Connect(function()
            PlayerESP.UpdatePlayerESP(player)
        end)
        connections.characterRemoving = player.CharacterRemoving:Connect(function()
            PlayerESP.RemovePlayerESP(player)
        end)

        table.insert(PlayerESP.ConnectionCache, { player = player, connections = connections })
    end
...
PlayerESP.HandleExistingPlayers = function()
    local playerList = Players:GetPlayers()
    for i = 1, #playerList do
        local player = playerList[i]
        if player.Name ~= LocalPlayerName then
            PlayerESP.OnPlayerAdded(player)
        end
    end
end

Players.PlayerAdded:Connect(PlayerESP.OnPlayerAdded)
Players.PlayerRemoving:Connect(function(player)
    PlayerESP.RemovePlayerESP(player)
    for i, cache in ipairs(PlayerESP.ConnectionCache) do
        if cache.player == player then
            for _, conn in pairs(cache.connections) do
                conn:Disconnect()
            end
            table.remove(PlayerESP.ConnectionCache, i)
            break
        end
    end
end)

PlayerESP.HandleExistingPlayers()

do -- \\ Player ESP Section
    local ESPPreview = Library:ESPPreview(Window, {Title = "ESP Preview"})
    local VisualsPage = Window:Page({Name = "Visuals", Columns = 2})
    local ESPSection = VisualsPage:Section({Name = "Player ESP", Side = 1})

    ESPSection:Toggle({Name = "Enable ESP", Flag = "ESP Enabled", Callback = function()
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
        ESPPreview:Set("Name", Library.Flags["ESP Enabled"], {Color = Library.Flags["Names Accent"].Color, Enabled = Library.Flags["Enable Names"], Text = Library.Flags["Display Name"] and LocalPlayer.DisplayName or LocalPlayer.Name})
        ESPPreview:Set("Healthbar", Library.Flags["ESP Enabled"], {Enabled = Library.Flags["Enable Healthbar"], TextEnabled = Library.Flags["Enable Healthtext"]})
        ESPPreview:Set("Distance", Library.Flags["ESP Enabled"], {Color = Library.Flags["Distance Accent"].Color, Enabled = Library.Flags["Enable Distance"]})
        ESPPreview:Set("Weapon", Library.Flags["ESP Enabled"], {Color = Library.Flags["Weapon Accent"].Color, Enabled = Library.Flags["Enable Weapon"]})
    end})

    ESPSection:Toggle({Name = "Boxes", Flag = "Enable Boxes", Callback = function(val)
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
    end}):Colorpicker({Name = "Boxes Color", Flag = "Boxes Accent", Default = Color3.fromRGB(255, 255, 255), Callback = function()
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
    end})

    ESPSection:Toggle({Name = "Boxes Filled", Flag = "Boxes Filled", Callback = function()
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
    end}):Colorpicker({Name = "Filled Boxes Color", Flag = "Filled Boxes Accent", Default = Color3.fromRGB(255, 255, 255), Callback = function()
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
    end})

    ESPSection:Toggle({Name = "Names", Flag = "Enable Names", Callback = function()
        ESPPreview:Set("Name", Library.Flags["ESP Enabled"], {Color = Library.Flags["Names Accent"].Color, Enabled = Library.Flags["Enable Names"], Text = Library.Flags["Display Name"] and LocalPlayer.DisplayName or LocalPlayer.Name})
    end}):Colorpicker({Name = "Names Color", Flag = "Names Accent", Default = Color3.fromRGB(255, 255, 255), Callback = function()
        ESPPreview:Set("Name", Library.Flags["ESP Enabled"], {Color = Library.Flags["Names Accent"].Color, Enabled = Library.Flags["Enable Names"], Text = Library.Flags["Display Name"] and LocalPlayer.DisplayName or LocalPlayer.Name})
    end})

    ESPSection:Toggle({Name = "Healthbar", Flag = "Enable Healthbar", Callback = function()
        ESPPreview:Set("Healthbar", Library.Flags["ESP Enabled"], {Enabled = Library.Flags["Enable Healthbar"], TextEnabled = Library.Flags["Enable Healthtext"]})
    end})

    ESPSection:Toggle({Name = "Healthtext", Flag = "Enable Healthtext", Callback = function()
        ESPPreview:Set("Healthbar", Library.Flags["ESP Enabled"], {Enabled = Library.Flags["Enable Healthbar"], TextEnabled = Library.Flags["Enable Healthtext"]})
    end})

    ESPSection:Toggle({Name = "Distance", Flag = "Enable Distance", Callback = function()
        ESPPreview:Set("Distance", Library.Flags["ESP Enabled"], {Color = Library.Flags["Distance Accent"].Color, Enabled = Library.Flags["Enable Distance"]})
    end}):Colorpicker({Name = "Distance Color", Flag = "Distance Accent", Default = Color3.fromRGB(255, 255, 255), Callback = function()
        ESPPreview:Set("Distance", Library.Flags["ESP Enabled"], {Color = Library.Flags["Distance Accent"].Color, Enabled = Library.Flags["Enable Distance"]})
    end})

    ESPSection:Toggle({Name = "Weapon", Flag = "Enable Weapon", Callback = function()
        ESPPreview:Set("Weapon", Library.Flags["ESP Enabled"], {Color = Library.Flags["Weapon Accent"].Color, Enabled = Library.Flags["Enable Weapon"]})
    end}):Colorpicker({Name = "Weapon Color", Flag = "Weapon Accent", Default = Color3.fromRGB(255, 255, 255), Callback = function()
        ESPPreview:Set("Weapon", Library.Flags["ESP Enabled"], {Color = Library.Flags["Weapon Accent"].Color, Enabled = Library.Flags["Enable Weapon"]})
    end})

do -- \\ Player ESP Settings Section
    local ESPSettings = VisualsPage:Section({Name = "Player ESP Settings", Side = 1})
    ESPSettings:Toggle({Name = "Team Check", Flag = "Enable TeamCheck"})
    ESPSettings:Toggle({Name = "Display Name", Flag = "Display Name"})
    ESPSettings:Slider({Name = "Max Distance Amount", Flag = "Max ESP Distance", Min = 0, Max = 10000, Default = 1000})
    ESPSettings:Slider({Name = "Boxes Filled Opacity Amount", Flag = "Boxes Filled Opacity", Min = 0, Max = 100, Default = 50, Callback = function()
        ESPPreview:Set("Box", Library.Flags["ESP Enabled"], {Filled = Library.Flags["Boxes Filled"], FillTransparency = Library.Flags["Boxes Filled Opacity"] / 100, Color = Library.Flags["Boxes Accent"].Color, Enabled = Library.Flags["Enable Boxes"], FillColor = Library.Flags["Filled Boxes Accent"].Color})
    end})
    end
end

local SettingsPage = Library:CreateSettingsPage(Window, Watermark, KeybindList) --if getgenv().Library then
--	getgenv().Library:Unload()
--end
